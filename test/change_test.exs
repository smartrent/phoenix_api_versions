defmodule PhoenixApiVersions.ChangeTest do
  ...
  defmodule TestChange do
    ...
    def transform_request_body_params(
          body_params,
          ExpectedControllerModule,
    ...
    def transform_request_query_params(
          query_params,
          ExpectedControllerModule,
          :expected_controller_action
        ) do
    ...
    def transform_request_path_params(
          path_params,
          ExpectedControllerModule,
          :expected_controller_action
        ) do
  ...
  describe "PhoenixApiVersions.Change.transform_response/2" do
    ...
    test "transform_response/3 has a default implementation that does no transformation" do
      ...
      transformed_output =
        ChangeWithoutFunctionOverrides.transform_response(output, %{conn: conn()})
